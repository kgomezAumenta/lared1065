        ...
        <main className="container mx-auto px-4 py-8 pb-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
                ...
                <div className="lg:col-span-3">
                    {/* Custom Header for Futbol Nacional */}
                        ...
                        <div className="w-full overflow-x-auto pb-4 hide-scrollbar">
                            <div className="flex gap-4 min-w-max items-center">
                                {[
                                    ...
                                    <Link key={team.name} href={`/search?q=${team.slug}&category=futbol-nacional`} title={team.name} className="flex-shrink-0 group flex flex-col items-center gap-2">
                                        <div className="w-12 h-12 rounded-full bg-gray-50 border border-gray-200 shadow-sm flex items-center justify-center p-1.5 group-hover:scale-110 group-hover:border-[#E40000] group-hover:shadow-md transition-all">
                                        ...
                                        <span className="text-[9px] font-bold text-gray-700 group-hover:text-[#E40000] uppercase tracking-tight text-center max-w-[60px] leading-tight line-clamp-2">
                                            {team.name}
                                        </span>
                                    </Link>
                                ))}
